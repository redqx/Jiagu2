...
//    jobject pathListObj = GetField( //这段
...
//    //在BaseDexClassLoader的构造函数中,会生成一个DexPathList
    ...
    dexElements = static_cast<jobjectArray>(CallStaticMethod( //做的工作类似于 makeDexElements??
    ...
    env->DeleteLocalRef(ElementClass_ByteBuffer);
